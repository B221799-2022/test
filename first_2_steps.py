...
#count the numbers of the species--they are in the squared brackets
  tem=set()
...
#ask the users to choose the number of sequence
while 1:
  n="hi"
  def answer():
    global b
    ...
    if choice.upper()=="Y":
      length=input("Perfect, the number of sequence is...(enter a number)")
      if length.isdigit():
        ...
        length=input("Please enter the number of sequence again...")
        length1=length
        b="bye"
    elif choice.upper()=="N":
...
while 1:
  h="hi"
  command2="cp ana1.fasta ana2.fasta"
  os.system(command2)
  def answer1():
    global c
    global IDuser
      ...
      while 1:
        ...
        def id():
          ...
          if IDuser in ID:
            ...
            command3="grep -w "+IDuser+" fastafile.fasta >> ana2.fasta"
            os.system(command3)
...
while 1:
  g="hi"
  command4="cp ana2.fasta ana3.fasta"
  os.system(command4)
  def answer2():
    global p
    global suser
      ...
      while 1:
        ...
        def species():
          ...
          if suser in tem:
            ...
            command5="grep -w "+"\'"+suser+"\'"+" fastafile.fasta >> ana3.fasta"
            os.system(command5)
  ...
  def winsize():
    ...
    if size.isdigit():
      if int(size)!=0:
        ...
        print("The size should be bigger than 0!")
        winsize()
    else:
...
cmd6="plotcon cluster.txt -winsize "+size+" -graph data"
os.system(cmd6)
print("The output data is saved now")
cmd7="grep -v '##' plotcon1.dat > plotcon.txt"
os.system(cmd7)

#tell the users what the data means
cmd8="grep -w 'Ymax' plotcon1.dat"
os.system(cmd8)
